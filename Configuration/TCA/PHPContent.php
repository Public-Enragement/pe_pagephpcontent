...
$GLOBALS['TCA']['tx_pepagephpcontentelement_domain_model_phpcontent'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_pepagephpcontentelement_domain_model_phpcontent']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, php_content',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, title, php_content, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
